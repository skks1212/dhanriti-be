...
from dhanriti.permissions import HasClosedBetaAccess
...
class GetPermissionClassesMixin:
    def get_permissions(self):
        ...
        try:
            ...
            return action_permissions + (HasClosedBetaAccess(),)
        except (KeyError, AttributeError):
            return tuple(super().get_permissions()) + (HasClosedBetaAccess(),)
